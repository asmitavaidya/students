...
public class PostgresStudentDaoImpl implements StudentDao {
	...
	public Student insertStudent(Student student) {
		...
		Student postedStudent = jdbcTemplate.queryForObject("select id, name, course from students where id=(select max(id) from students)", new StudentRowMapper());
		return postedStudent;
	}
